package flexUnitTests
{
  ...
  import org.juicekit.query.And;
  import org.juicekit.query.Arithmetic;
  import org.juicekit.query.Comparison;
  import org.juicekit.query.Expression;
  import org.juicekit.query.If;
  import org.juicekit.query.Literal;
  import org.juicekit.query.Or;
  import org.juicekit.query.Query;
  import org.juicekit.query.Range;
  import org.juicekit.query.Variable;
  import org.juicekit.query.Xor;
	...
	public class ExpressionTests extends TestCase
	{
		...
		private function _runTests():void
		{
			...
			for (var i:uint=0; i<tests.length; ++i) {
				...
				assertEquals(tests[i].result, val);
			}
		}
